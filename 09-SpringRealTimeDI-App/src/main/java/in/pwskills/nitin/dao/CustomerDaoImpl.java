...
public final class CustomerDaoImpl implements ICustomerDao {
	...
	private static final String SQL_INSERT_QUERY = "insert into customer(`custName`,`custAddr`,`pamt`,`rate`,`time`,`interestAmount`) values(?,?,?,?,?,?)";
	@Autowired
	...
	public int insert(CustomerBO bo) throws Exception {
		...
		try(Connection connection  = dataSource.getConnection()){
			...
			//set the values to precompiled query
